...
const COMPARISONS = [
  {
    ...
    now: '압도적 가성비, 빠른 구축',
    nowNote: '오픈소스 기반으로 라이선스 부담 없이 빠른 초기 개발과 핵심 기능 검증이 가능합니다.',
  },
  {
    old: '연동 부재로 반복되는 수작업',
    oldNote: '담당자가 있어도 시스템이 이어지지 않아 매번 전화하고 엑셀로 견적을 다시 정리합니다.',
    now: 'ERP 데이터 직접 연동 · AI 자동화',
  ...
  },
  {
    ...
    now: '표준 구매문서 기반',
    nowNote: '전 세계적으로 널리 쓰이는 제품 · 구매 요청서 · 견적 요청서 · 발주서 구조라 적용과 확장이 빠릅니다.',
  },
  {
    old: '전체 플랫폼 교체 · 신규 구축',
    oldNote: '기존 ERP와 프로세스를 대체하는 방식이라 전환 비용과 도입 리스크가 큽니다.',
    now: '기존 ERP 위에 연결하는 가벼운 AI 자동화 계층',
